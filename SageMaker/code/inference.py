...
users_file = os.path.abspath("code/normalizedValues.csv")
diningRates_file = os.path.abspath("code/dining_ratings.csv")
diningHalls_file = os.path.abspath("code/alldininghalls.csv")
    ...
    if len(dHallPref) > 0:
        ...
        for item in recs:
            ...
            for pref in dHallPref:
                ...
                if item[pref] == 1:
                    ...
                    key = "code/cachedData/{}-{}-{}-{}-{}.json".format(pref.capitalize(), meal, mm, dd, yyyy) # pref is the dining hall
        ...
        for item in recs:
            ...
            for dining_hall in dHalls:
                ...
                key = "code/{}-{}-{}-{}-{}.json".format(dining_hall, meal, mm, dd, yyyy) # pref is the dining hall
                data = json.loads(key)
